...
#define MODULENAME "3DMaterialBlinn"

#define BaseClass MtlData3D 
#define ThisClass MtlBlinnData3D 
...
MtlBlinnData3D::MtlBlinnData3D(const Registry *reg, const ScriptVal &table, const TagList &tags) : BaseClass(reg, table, tags)
{
...
MtlBlinnData3D::MtlBlinnData3D(const MtlBlinnData3D &toCopy) : BaseClass(toCopy)
{
...
MtlBlinnData3D::~MtlBlinnData3D()
{
}

Data3D *MtlBlinnData3D::CopyTagList(TagList &tags)
{
	return new MtlBlinnData3D(*this);
}

bool MtlBlinnData3D::CreateManagedParams()
{
...
const Registry *MtlBlinnData3D::GetImplRegistry(uint32 type)
{
	const Registry *ret = NULL;

	if (m_RegNode == &MtlBlinnData3D::Reg)		// so subclasses aren't forced to also override this func
	{
		switch (type)
		{
			case CT_MtlImplSW3D:
				ret = &MtlBlinnSW3D::Reg;
				break;
			case CT_MtlImplGL3D:
				ret = &MtlBlinnGL3D::Reg;
				break;
		}
	}
	else
...
void MtlBlinnData3D::Use()
{
	BaseClass::Use();
}

void MtlBlinnData3D::Recycle()
{
	BaseClass::Recycle();
}
...
#define ThisClass MtlBlinnGL3D 
FuRegisterClass(COMPANY_ID_DOT + CLSID_MtlBlinnGL, CT_MtlImplGL3D)
	REGS_Name,					COMPANY_ID "MtlBlinnGL3D",
	REGID_MaterialLongID,	LongID_MtlBlinn,
	TAG_DONE);

MtlBlinnGL3D::MtlBlinnGL3D(const Registry *reg, const ScriptVal &table, const TagList &tags) : BaseClass(reg, table, tags)
{
}

MtlBlinnGL3D::~MtlBlinnGL3D()
{
}

bool MtlBlinnGL3D::CreateChildMtls(RenderContextGL3D &rc)
{
	if (rc.ShadePath == SP_FixedFunction)
	{
		MtlData3D *diffuseMtl = MtlData->GetChildMtl(MtlBlinnData3D::CMS_Diffuse);
...
bool MtlBlinnGL3D::ConnectParams(RenderContextGL3D &rc, ShaderCg *shader, ShadeNodeCg *node, ParamCg mtlStruct)
{
...
bool MtlBlinnGL3D::ConnectChildMtls(RenderContextGL3D &rc, ShaderCg *shader, ShadeNodeCg *node, ParamCg mtlStruct)
{
	BlinnCg *sn = (BlinnCg *) node;
...
ShadeNodeCg *MtlBlinnGL3D::CreateShadeNode(RenderContextGL3D &rc)
{
	return new BlinnCg;
}

const char *MtlBlinnGL3D::GetShadeNodeName(RenderContextGL3D &rc)
{
	return "FuMtlBlinn";
}

const char *MtlBlinnGL3D::GetShaderFilename(RenderContextGL3D &rc)
{
...
ParamBlockSW *MtlBlinnSW3D::CreateParamBlock(RenderContextSW3D &rc)
{
	MtlBlinnData3D *mtlData = (MtlBlinnData3D *) MtlData;
...
bool MtlBlinnSW3D::PreRender(RenderContextSW3D &rc)
{
	return true;
}

void MtlBlinnSW3D::PostRender(RenderContextSW3D &rc)
{
}

bool MtlBlinnSW3D::Activate(RenderContextSW3D &rc)
{
	return true;
}

void MtlBlinnSW3D::Deactivate(RenderContextSW3D &rc)
{
}
...
//
//
// MtlBlinnInputs3D class
//
//
#undef BaseClass
#undef ThisClass
#define BaseClass MtlInputs3D 
#define ThisClass MtlBlinnInputs3D 

FuRegisterClass(COMPANY_ID_DOT + CLSID_MtlBlinnInputs, CT_MtlInputs3D)
	REGS_Name,					COMPANY_ID "Blinn Material Inputs",
	REGID_MaterialLongID,	LongID_MtlBlinn,
	TAG_DONE);

MtlBlinnInputs3D::MtlBlinnInputs3D(const Registry *reg, const ScriptVal &table, const TagList &tags) : BaseClass(reg, table, tags)
{
	InDiffuseNest = NULL;
...
MtlBlinnInputs3D::~MtlBlinnInputs3D()
{
}

bool MtlBlinnInputs3D::RegInit(Registry *regnode)
{
	return BaseClass::RegInit(regnode);
}

void MtlBlinnInputs3D::RegCleanup(Registry *regnode)
{
	BaseClass::RegCleanup(regnode);
}

bool MtlBlinnInputs3D::SetAttrsTagList(const TagList &tags)
{
	return BaseClass::SetAttrsTagList(tags);
}

bool MtlBlinnInputs3D::CopyAttr(Tag tag, void *addr) const
{
	return BaseClass::CopyAttr(tag, addr);
}

void MtlBlinnInputs3D::OnAddToFlow(TagList *tags)
{
	BaseClass::OnAddToFlow(tags);
}

void MtlBlinnInputs3D::OnRemoveFromFlow(TagList *tags)
{
	BaseClass::OnRemoveFromFlow(tags);
}

bool MtlBlinnInputs3D::AddInputsTagList(TagList &tags)
{
...
void MtlBlinnInputs3D::ShowInputs(bool visible)
{
	BaseClass::ShowInputs(visible);
}

void MtlBlinnInputs3D::AddAllBlinnInputs()
{
	AddDiffuseBlinnInputs();

	BeginSpecularBlinnNest();
		AddSpecularBlinnInputs();
...
void MtlBlinnInputs3D::BeginSpecularBlinnNest()
{
...
void MtlBlinnInputs3D::NotifyChanged(Input *in, Parameter *param, TimeStamp time, TagList *tags)
{
...
MtlBlinnData3D *MtlBlinnInputs3D::ProcessBlinnInputs(Request *req, MtlBlinnData3D *data)
{
	if (!data)
		return NULL;
	...
	data->SetChildMtl(MtlBlinnData3D::CMS_Diffuse, InDiffuseMtl->GetValue(req));
	...
	data->SetChildMtl(MtlBlinnData3D::CMS_Specular, InSpecularColorMtl->GetValue(req));

	// specular intensity
	data->SpecularIntensity = *InSpecularIntensity->GetValue(req);
	data->SetChildMtl(MtlBlinnData3D::CMS_SpecularIntensity, InSpecularIntensityMtl->GetValue(req));

	// specular exponent
	if (InSpecularExponent)
	{
		data->SpecularExponent = *InSpecularExponent->GetValue(req);
		data->SetChildMtl(MtlBlinnData3D::CMS_SpecularExponent, InSpecularExponentMtl->GetValue(req));
	}

	// bumpmap
	data->SetChildMtl(MtlBlinnData3D::CMS_Bumpmap, InBumpmapMtl->GetValue(req));
...
Data3D *MtlBlinnInputs3D::ProcessTagList(Request *req, Data3D *data, TagList &tags)
{
	// This is where we would in->GetValue(req) and stored the results in the MtlBlinnData3D object for any unmanaged inputs.

	if (!data)
		data = new MtlBlinnData3D(&MtlBlinnData3D::Reg, nil, TagList());

	if (data)
	{
		FuASSERT(data->IsTypeOf(CLSID_MtlBlinnData), (""));
		ProcessBlinnInputs(req, (MtlBlinnData3D *) data);
	}
...
#define ThisClass MtlBlinn3D 

FuRegisterClass(COMPANY_ID_DOT + CLSID_MtlBlinn, CT_Material3D)
	REGS_Name,					COMPANY_ID_SPACE "Blinn",
	REGS_OpIconString,		"3Bl",
	REGS_Category,				COMPANY_ID_DBS "3D\\Material",
	REGS_OpDescription,		"Blinn Material",
	REGS_HelpTopic,			"Tools/3D/Material/Blinn",
	REGS_AboutDescription,	"Generate a Blinn material",
	REGID_MaterialLongID,	LongID_MtlBlinn,
...
MtlBlinn3D::~MtlBlinn3D()
{
	SAFE_RECYCLE(MtlInputs);
}

bool MtlBlinn3D::RegInit(Registry *regnode)
{
	return BaseClass::RegInit(regnode);
}

void MtlBlinn3D::RegCleanup(Registry *regnode)
{
	BaseClass::RegCleanup(regnode);
}

bool MtlBlinn3D::SetAttrsTagList(const TagList &tags)
{
	return BaseClass::SetAttrsTagList(tags);
}

bool MtlBlinn3D::CopyAttr(Tag tag, void *addr) const
{
	return BaseClass::CopyAttr(tag, addr);
}

void MtlBlinn3D::Process(Request *req)
{
	BaseClass::Process(req);
}

void MtlBlinn3D::NotifyChanged(Input *in, Parameter *param, TimeStamp time, TagList *tags)
{
	if (param && in)
	{
	}
...
void MtlBlinn3D::OnAddToFlow(TagList *tags)
{
...
void MtlBlinn3D::OnRemoveFromFlow(TagList *tags)
{
	BaseClass::OnRemoveFromFlow(tags);
}
